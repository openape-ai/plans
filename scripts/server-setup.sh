...
#
# What it does:
#   - Creates /home/$DEPLOY_USER/projects/openape-plans/{releases,shared/data}
#   - Installs /etc/systemd/system/$DEPLOY_SERVICE systemd unit
#   - Extends /etc/sudoers.d/openape-plans to allow restart
...
DEPLOY_SERVICE="${DEPLOY_SERVICE:-openape-plans.service}"
DEPLOY_PORT="${DEPLOY_PORT:-3004}"
PUBLIC_HOST="${PUBLIC_HOST:-plans.openape.ai}"
BASE="/home/${DEPLOY_USER}/projects/openape-plans"
...
[Unit]
Description=OpenApe Plans (Nuxt)
...
SUDOERS_FILE="/etc/sudoers.d/openape-plans"

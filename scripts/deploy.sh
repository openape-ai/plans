...
#   DEPLOY_BASE     Base directory on target (default: "/home/${DEPLOY_USER}/projects/openape-plans")
#   DEPLOY_PORT     Port the app should listen on (default: 3004)
#   DEPLOY_SERVICE  systemd unit name (default: "openape-plans.service")
...
DEPLOY_BASE="${DEPLOY_BASE:-/home/${DEPLOY_USER}/projects/openape-plans}"
...
pnpm --filter @openape-plans/app build
